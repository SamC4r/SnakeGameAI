...
SNAKE_BODY = pygame.transform.scale(pygame.image.load(os.path.join(r"C:\Users\Administrator\Desktop\HAX\SNAKETUTO\images\snakebody.png")),(20,20))
APPLE = pygame.transform.scale(pygame.image.load(os.path.join(r"C:\Users\Administrator\Desktop\HAX\SNAKETUTO\images\manzana.png")),(20,20))
SNAKE_HEAD = []
for x in range(1,5):
	SNAKE_HEAD+=[pygame.transform.scale(pygame.image.load(os.path.join(r"C:\Users\Administrator\Desktop\HAX\SNAKETUTO\images\SnakeHead"+str(x)+".png")),(20,20))]
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description='Snake AI with Neat')
	parser.add_argument('-p', '--population', help='load_population_results')
